...
typedef void (*sha512Fn)(const unsigned char*, size_t, unsigned char*);
typedef void (*sha512_3Fn)(const unsigned char*, size_t, const unsigned char*, size_t, const unsigned char*, size_t, unsigned char*);
