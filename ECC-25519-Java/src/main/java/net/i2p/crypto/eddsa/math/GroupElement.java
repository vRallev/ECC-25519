...
public class GroupElement implements Serializable {
    ...
    /**
     * Precomputed table for {@link net.i2p.crypto.eddsa.math.GroupElement#scalarMultiply(byte[])},
     * filled if necessary.
     *
     * Variable is package private only so that tests run.
     */
    GroupElement[][] precmp;
    /**
     * Precomputed table for {@link net.i2p.crypto.eddsa.math.GroupElement#doubleScalarMultiplyVariableTime(net.i2p.crypto.eddsa.math.GroupElement, byte[], byte[])},
     * filled if necessary.
     *
     * Variable is package private only so that tests run.
     */
    ...
    /**
     * Precompute the tables for {@link net.i2p.crypto.eddsa.math.GroupElement#scalarMultiply(byte[])}
     * and {@link net.i2p.crypto.eddsa.math.GroupElement#doubleScalarMultiplyVariableTime(net.i2p.crypto.eddsa.math.GroupElement, byte[], byte[])}.
     *
